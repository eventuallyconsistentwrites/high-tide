...
* [K6 Log Visualizer](#k6-log-visualizer)
  ...
  * [Output Interpretation](#output-interpretation)
    * [1. Total System Throughput (Left Chart)](#1-total-system-throughput-left-chart)
    * [2. Response Latency (Right Chart)](#2-response-latency-right-chart)
...
Here is the complete Markdown documentation for the `visualize_k6.py` script. You can save this as `README.md` alongside the script.
